...
def calculate_avg_angles(angles):
    avg_angles = (((angles.back_angles+angles.back_angles2)/2) + ((angles.legs_angles+angles.legs_angles2)/2) + ((angles.elbow_angles+angles.elbow_angles2)/2) + ((angles.armpit_angles+angles.armpit_angles2)/2))
    return(avg_angles)
